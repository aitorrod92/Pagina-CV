...
VALUES 
(1, 'Ayudante de investigación', null, '2014-11-1', '2015-3-31', DATEDIFF('2015/03/31', '2014/11/01')/30, 'Universidad de Alcalá', 'Alcalá de Henares', 'España', 
...
(2, 'Profesor de Biología', null, '2016-2-1', '2016-5-31', DATEDIFF('2016/05/31', '2016/02/01')/30, 'IES "Villa de Vallecas"', 'Madrid', 'España',
...
(3, 'Taquillero', null, '2016-9-1', '2016-12-31', DATEDIFF('2016/12/31', '2016/09/01')/30, 'Brunch In The Park', 'Madrid', 'España',
'- Venta de entradas usando TPV.
- Balance de caja.',
FALSE, 'Otro', 'Parcial', 'Venta Cara al público'),
(4, 'Mozo multitarea', null, '2016-10-01', '2017-5-31', DATEDIFF('2017-5-31', '2016-10-01')/30, 'Parque de Atracciones de Madrid', 'Madrid', 'España',
...
(5, 'Crew Trainer', null, '2017-7-01', '2020-6-30', DATEDIFF('2020-6-30', '2017-7-01')/30, 'McDonald\'s', 'Brighton and Hove', 'Reino Unido',
...
(6, 'Desarrollador web', null, '2020-9-01', '2020-12-31', DATEDIFF('2020-12-31', '2020-9-01')/30, 'Nubemedia', 'Madrid','España',
...
(7, 'Consultor SAP SuccessFactors', null, '2021-4-01', '2021-5-31', DATEDIFF('2021-5-31', '2021-4-01')/30, 'Deloitte', 'Madrid', 'España',
'', FALSE, 'IT', null, 'Informática IT Consultoría SAP SuccessFactors');
