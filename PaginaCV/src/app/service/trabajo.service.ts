...
export class TrabajoService {
	...
	getTrabajosListbyCategory(categoryWord: string, categoria: number, jobWord: string): Observable<Trabajo[]> {
		this.searchUrl = `${this.baseUrl}/${categoryWord}/${categoria}/${jobWord}`
